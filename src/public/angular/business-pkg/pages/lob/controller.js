    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#lobs_list').DataTable({
            ...
            columns: [
                ...
                { data: 'code', name: 'lobs.code' },
                { data: 'name', name: 'lobs.name' },
                { data: 'mobile_no', name: 'lobs.mobile_no' },
                { data: 'email', name: 'lobs.email' },
            ],
...
app.component('lobForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        ...
        $scope.onSelectedCountry = function(id) {
            lob_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                lob_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            lob_get_city_by_state = vendor_get_city_by_state
            $http.post(
                lob_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
